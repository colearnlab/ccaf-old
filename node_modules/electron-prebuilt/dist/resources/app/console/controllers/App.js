var App = (function(){
  var App = {
    'controller': function() {
      ...
      var classroom = m.prop(null);
      var interval = setInterval(function() {
        if (conn.readyState === conn.OPEN) {
          clearInterval(interval);

          conn.send(JSON.stringify({'channel': 'data-associate', 'message': {'classroom': m.route.param('classroom')}}));

          stm.onchange = function(_state) {
            classroom(_state);
            m.redraw();
          };
    ...
    'view': function(ctrl) {
      ...
      return (
        m('div', [
          ...
          m('br'),
          (typeof page === 'undefined' || ctrl.classroom() === null ? m('br') : m.component(page.controller, {'classroom': ctrl.classroom()}))
        ])
      );
    }
  };
