    ...
    view: function(ctrl, args) {
      ...
      return (
        m('div.deviceTile' + (device.connected ? '.deviceActive' : ''), {
          'style': 'z-index: 2; position: absolute; webkit-transform: translate(' + x + 'px, ' + y + 'px); transform: translate(' + x + 'px, ' + y + 'px);',
          'data-x': x,
          'data-y': y,
          'data-id': device.id,
          ...
          m('div.panel.panel-default.resizeTile' + (!device.connected ? '.trashable' : ''), {
            'style':
              'position: relative; ' +
          ...
          m('div.deviceName', [
            ctrl.edit
              ...
              : m('div', {'onclick': function(e) { ctrl.toggle = false; ctrl.edit = true; }}, [device.name])
          ]),
          m('div.btn-group.btn-group-sm', {
            'style': (ctrl.toggle ? 'visibility: visible' : 'visibility: hidden') + '; display: table; margin-left: auto; margin-right: auto'
            }, [
          ...
          m('button.btn.btn-lg.btn-success', {
            ...
            'onclick': function(e) {
              stm.try(function(state) {
                ...
                devices.push({'id': state.props('deviceIndex'), 'name': 'New device', 'color': 'green', 'location': {'x': 75, 'y': 75}, 'screen': {'width': 5, 'height': 5}});
