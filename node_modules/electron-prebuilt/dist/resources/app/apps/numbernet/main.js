define(function() {
  ...
  exports.start = function(_cb) {
    ...
    cb.try(function(state) {
      if (!('results' in state.self))
        state.self('results', []);
      if (!('calculators' in state.self))
        state.self('calculators', []);
    }).then(function(state) {
      //state.self.results().forEach(function(result) {});
      state.self.calculators().forEach(function(calculator) {
