  ...
  exports.startApp = function(_cb, parentElement) {
    ...
    cb.try(function(state) {
      ...
      calculators.forEach(function(calc, index) {
        var c = document.getElementById('calculator-' + index);
        c.style.webkitTransform =
        c.style.transform = 'translate(' + (calc.x || 0) + 'px, ' + (calc.y || 0) + 'px) rotate(' + (calc.angle || 0) + 'deg)';
      });
    }).done();
