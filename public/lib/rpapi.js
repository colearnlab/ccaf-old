...
define(function() {
  ...
  exports.createBound = function(appDir) {
    var b = function(state) {
      var api = new API(state);
      api.app = b.app;
      api.appPath = b.appPath;
      return api;
    };

    b.app = appDir;
    b.appPath = '/apps/' + appDir + '/';
  ...
  API.prototype = {
    ...
    'appRoot': function() {
      if (typeof this.state.appRoot === 'undefined' || typeof this.state.appRoot[this.app] === 'undefined')
        return null;

      return this.state.appRoot[this.app];
    }
  };
