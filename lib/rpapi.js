...
define(function() {
  ...
  // Operates as a wrapper, so we follow the jQuery pattern: e.g. api.using(state).devices();
  ...
  Device.prototype = {
    ...
    'projecting': function() {
      return typeof this.device('project') !== 'undefined' ? this.device('project') : false;
    }
  };
